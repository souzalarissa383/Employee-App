...
const EmployeeListScreen = () => {
  ...
  const filteredEmployees = employees.filter((employee) => {
    ...
    const admissionDateFormatted = formatDate(employee.admission_date).toLowerCase(); // Formata a data de admissão

    console.log('Data de admissão formatada:', admissionDateFormatted); // Verifique no console
    console.log('Texto de pesquisa:', searchLower); // Verifique no console

    return (
      employee.name.toLowerCase().includes(searchLower) ||
      employee.job.toLowerCase().includes(searchLower) ||
      employee.phone.toLowerCase().includes(searchLower) ||
      admissionDateFormatted.includes(searchLower) // Adiciona a busca por data de admissão
    );
  });
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <View style={styles.notificationContainer}>
          <TouchableOpacity onPress={() => { /* Handle notification press */ }}>
